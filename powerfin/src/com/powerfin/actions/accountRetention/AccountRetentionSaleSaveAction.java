...
public class AccountRetentionSaleSaveAction extends SaveAction{
	...
	public void execute() throws Exception {
		...
		if (getErrors().isEmpty()) {
            ...
            TransactionModule tm = XPersistence.getManager().find(TransactionModule.class, AccountRetentionHelper.RETENTION_SALE_TRANSACTION_MODULE);
            ...
            if (transactions.isEmpty())
            {
            	Transaction transaction = TransactionHelper.getNewInitTransaction();
     			...
     			transaction.setDebitAccount(accountRetention.getAccount());
