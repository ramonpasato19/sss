...
public class GeneratePrepaymentBalanceValueDate extends ViewBaseAction {
	...
	public void execute() throws Exception {
		...
		List<AccountOverdueBalance> overdueBalances = AccountLoanHelper.getOverdueBalances(account, accountingDate, true);
