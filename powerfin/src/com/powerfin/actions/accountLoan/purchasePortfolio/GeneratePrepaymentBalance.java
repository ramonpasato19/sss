...
public class GeneratePrepaymentBalance extends ViewBaseAction {
	...
	public void execute() throws Exception {
		...
		List<AccountOverdueBalance> overdueBalances = AccountLoanHelper.getOverdueBalances(account, null, true);
