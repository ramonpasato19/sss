...
public class SpreadPurchasePortfolioSaveAction extends ViewBaseAction  {
	...
	public void execute() throws Exception {
		...
		}else
		{
			...
			TransactionModule transactionModule = XPersistence.getManager().find(TransactionModule.class, BatchProcessHelper.SPREAD_PURCHASE_PORTFOLIO_TRANSACTION_MODULE);
			...
			for (BatchProcessDetail detail : batchProcessDetails)
			{
				...
				Transaction transaction = TransactionHelper.getNewInitTransaction();
	  			...
	  			transaction.setValue(quota.getPurchaseSpread());
