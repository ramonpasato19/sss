...
public class ReceivableSalePortfolioSaveAction extends ViewBaseAction  {
	...
	public void execute() throws Exception {
		...
		}else
		{
			...
			TransactionModule transactionModule = XPersistence.getManager().find(TransactionModule.class, BatchProcessHelper.RECEIVABLE_SALE_PORTFOLIO_TRANSACTION_MODULE);
