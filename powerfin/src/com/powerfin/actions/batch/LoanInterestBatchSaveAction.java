...
public class LoanInterestBatchSaveAction extends ViewBaseAction  {
	...
	public void execute() throws Exception {
		...
		}else
		{
			...
			TransactionModule transactionModule = XPersistence.getManager().find(TransactionModule.class, BatchProcessHelper.LOAN_INTEREST_TRANSACTION_MODULE);
			...
			for (BatchProcessDetail detail : batchProcessDetails)
			{
				...
				Transaction transaction = TransactionHelper.getNewInitTransaction();
	  			...
	  			transaction.setValue(quota.getInterest());
