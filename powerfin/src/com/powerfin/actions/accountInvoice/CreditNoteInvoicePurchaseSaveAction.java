...
public class CreditNoteInvoicePurchaseSaveAction extends SaveAction{
		...
		if (getErrors().isEmpty()) {
            ...
            if (transactions.isEmpty())
            {
            	Transaction transaction = TransactionHelper.getNewInitTransaction();
     			...
     			transaction.setDebitAccount(accountInvoice.getAccountModified().getAccount());
	...
	private void validate() throws Exception {
		...
		if (getView().getSubview("accountModified").getValueString("accountId") == null)
