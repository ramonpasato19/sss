...
public class TXPurchasePortfolioPrepaymentSaveAction extends TXSaveAction {
	...
	public List<TransactionAccount> getTransactionAccounts(Transaction transaction) throws Exception
	{
		...
		System.out.println("valor xxxxxxxxxx:"+ spreadValue.toString());
