 ...
 */
@Embeddable
public class BalanceAccountingKey implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof BalanceAccountingKey)) {
			return false;
		}
		BalanceAccountingKey castOther = (BalanceAccountingKey)other;
		return 
