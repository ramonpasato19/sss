...
public class Transaction implements Serializable {
	...
	@ReadOnly(forViews = "AuthorizeTXGeneral,AuthorizeTXManualAccountingEntry")
	@CollectionViews({
	...
	@ReferenceViews({
		...
		@ReferenceView(forViews="RequestTXPurchasePortfolioPayment, AuthorizeTXPurchasePortfolioPayment", value="PurchasePortfolioPayment")
	})
	@NoFrame
	@ReadOnly(forViews = "AuthorizeTXOpening, "
			+ "AuthorizeTXTransferSent, "
	...
	public void fillRequestingInfo() {
	...
	public void fillAuthorizingInfo() {
		if (transactionStatus.equals(transactionModule.getFinancialTransactionStatus()))
		{
