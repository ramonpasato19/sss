 ...
 */
@Entity
@Table(name="account_paytable_old")

public class AccountPaytableOld implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="account_paytable_old_id", unique=true, nullable=false, length=32)
	@Hidden
	@GeneratedValue(generator="system-uuid") 
	@GenericGenerator(name="system-uuid", strategy = "uuid")
	private String accountPaytableOldId;
	...
	@Column(name="paytable_type", nullable=false)
	private String paytableType;
	...
	public String getAccountPaytableOldId() {
		return accountPaytableOldId;
	}

	public void setAccountPaytableOldId(String accountPaytableOldId) {
		this.accountPaytableOldId = accountPaytableOldId;
	}

	public String getPaytableType() {
		return paytableType;
	}

	public void setPaytableType(String paytableType) {
