...
public class TransactionAccountHelper {
	...
	public static TransactionAccount createCustomCreditTransactionAccount(Account account,
			BigDecimal value, BigDecimal quantity, Unity unity, Transaction transaction) throws Exception {
		return TransactionAccountHelper.createCustomCreditTransactionAccount(account, value,quantity, unity, transaction, CategoryHelper.getBalanceCategory());
	}
	...
	public static TransactionAccount createCustomDebitTransactionAccount(Account account,
			BigDecimal value, BigDecimal quantity, Unity unity, Transaction transaction) throws Exception {
		return TransactionAccountHelper.createCustomDebitTransactionAccount(account, value, quantity, unity, transaction, CategoryHelper.getBalanceCategory());
	}
	...
	public static TransactionAccount createCustomCreditTransactionAccount(Account account,
			BigDecimal value, BigDecimal quantity, Unity unity, Transaction transaction, Category category) throws Exception {
		return TransactionAccountHelper.createCustomCreditTransactionAccount(account, value, quantity, unity, transaction, category, null);
	}
	...
	public static TransactionAccount createCustomDebitTransactionAccount(Account account,
			BigDecimal value,BigDecimal quantity, Unity unity, Transaction transaction, Category category) throws Exception {
		return TransactionAccountHelper.createCustomDebitTransactionAccount(account, value,quantity,unity, transaction,  category, null);
	}
	...
	public static TransactionAccount createCustomCreditTransactionAccount(Account account,
			BigDecimal value, BigDecimal quantity, Unity unity, Transaction transaction, Category category, Types.YesNoIntegerType updateBalance) throws Exception {
		return TransactionAccountHelper.createTransactionAccount(account, 0, category, DebitOrCredit.CREDIT, value, quantity, unity, transaction, updateBalance, null, null);
	}
	...
	public static TransactionAccount createCustomDebitTransactionAccount(Account account,
			BigDecimal value, BigDecimal quantity, Unity unity, Transaction transaction, Category category, Types.YesNoIntegerType updateBalance) throws Exception {
		return TransactionAccountHelper.createTransactionAccount(account, 0, category, DebitOrCredit.DEBIT, value, quantity, unity, transaction, updateBalance, null, null);
	}
