...
public class AccountTermHelper {
	...
	public final static String TERM_OPENING_TRANSACTION_MODULE = "TERMOPENING";
	
	public final static String INTEREST_PAYTABLE_TYPE_ID = "001";
	public final static String CAPITAL_INTEREST_PAYTABLE_TYPE_ID = "002";
